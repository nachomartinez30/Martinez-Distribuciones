...
public class AgregarProducto extends JFrame {
	...
	public AgregarProducto() {
		...
		btnAgregar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				prod.insertarProducto(conexion.getConnection());

				textNombreProducto.setText("");
				textCodigo.setText(Integer.toString(prod.ultimoProducto(conexion.getConnection())));
		...
		int ultimo = prod.ultimoProducto(conexion.getConnection());
	...
	public static void EscribirArchivo(String linea, String tipo) {
		...
		try {
			...
			bw.write(linea);
			bw.newLine(); // ahora cerramos los flujos de canales de datos, al
							// cerrarlos el archivo quedará guardado con
							// información escrita

	...
	public InterfazPrincipal() {
		...
		btnAgregar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String Espacios1 = "                                "/* 35 espacios */,
						Espacio2 = "                    "/* 20 espacios */, Espacio3 = "                     ";
				...
				prod.buscarProducto(conexion.getConnection());
		...
		prod.AgregarSugerenciaProductos(conexion.getConnection());

	...
	public AgregarCliente() {
		...
		rdbtnFacturacion.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				codigo = cliFact.ultimoCliente(conexion.getConnection());
		...
		rdbtnRemision.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				codigo = cliRemi.ultimoCliente(conexion.getConnection());
				textCodigo.setText(Integer.toString(codigo));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (rdbtnFacturacion.isSelected() && rdbtnRemision.isSelected()) {
					...
					if (rdbtnFacturacion.isSelected()) {
						...
						if (rfc.equals("")) {
							JOptionPane.showMessageDialog(null, "Porfavor ingrese el RFC", "Error",
									JOptionPane.ERROR_MESSAGE);
							...
							cliFact.insertarCliente(conexion.getConnection());
					...
					if (rdbtnRemision.isSelected()) {
						...
						cliRemi.insertarCliente(conexion.getConnection());
